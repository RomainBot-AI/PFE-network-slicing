...
RUNS = {
    "prophet_tuned": {
        "path": "forecasting/experiments/runs/prophet_benchmark_tuned",
        "label": "Prophet tuned",
        "family": "statistical",
        "probabilistic": "Native prediction intervals; calibrate coverage per slice because deterministic runs show bias.",
    },
    "lightgbm_tuned": {
        "path": "forecasting/experiments/runs/deterministic_benchmark_lightgbm_tuned",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--doc", default="forecasting/docs/probabilistic_candidate_selection.md")
