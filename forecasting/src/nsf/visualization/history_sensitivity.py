...
DEFAULT_RUNS = {
    ("14d", "prophet_tuned"): "forecasting/experiments/runs/prophet_benchmark_tuned",
    ("7d", "prophet_tuned"): "forecasting/experiments/runs/prophet_benchmark_tuned_hist1w",
    ("1d", "prophet_tuned"): "forecasting/experiments/runs/prophet_benchmark_tuned_hist1d",
    ("14d", "lightgbm_tuned"): "forecasting/experiments/runs/deterministic_benchmark_lightgbm_tuned",
    ("7d", "lightgbm_tuned"): "forecasting/experiments/runs/deterministic_benchmark_lightgbm_tuned_hist1w",
    ("1d", "lightgbm_tuned"): "forecasting/experiments/runs/deterministic_benchmark_lightgbm_tuned_hist1d",
    ("14d", "lstm_5000w"): "forecasting/experiments/runs/lstm_benchmark_5000w",
    ("7d", "lstm_5000w"): "forecasting/experiments/runs/lstm_benchmark_5000w_hist1w",
    ("1d", "lstm_5000w"): "forecasting/experiments/runs/lstm_benchmark_5000w_hist1d",
    ("14d", "patchtst_tuned"): "forecasting/experiments/runs/patchtst_benchmark_tuned",
    ("7d", "patchtst_tuned"): "forecasting/experiments/runs/patchtst_benchmark_tuned_hist1w",
    ("1d", "patchtst_tuned"): "forecasting/experiments/runs/patchtst_benchmark_tuned_hist1d",
    ("14d", "nhits_tuned"): "forecasting/experiments/runs/nhits_benchmark_tuned",
    ("7d", "nhits_tuned"): "forecasting/experiments/runs/nhits_benchmark_tuned_hist1w",
    ("1d", "nhits_tuned"): "forecasting/experiments/runs/nhits_benchmark_tuned_hist1d",
}
