...
DEFAULT_RUNS = {
    "lightgbm_tuned": "experiments/runs/deterministic_benchmark_lightgbm_tuned",
    "lstm_5000w": "experiments/runs/lstm_benchmark_5000w",
    "prophet_tuned": "experiments/runs/prophet_benchmark_tuned",
    "nhits_tuned": "experiments/runs/nhits_benchmark_tuned",
    "nhits_robust_tuned": "experiments/runs/nhits_benchmark_robust_tuned",
    "patchtst_tuned": "experiments/runs/patchtst_benchmark_tuned",
    "patchtst_fast": "experiments/runs/patchtst_benchmark_fast",
    "patchtst_balanced": "experiments/runs/patchtst_benchmark_balanced",
    "patchtst_heavy1h": "experiments/runs/patchtst_benchmark_heavy1h",
}
